///////////////////////////////////////////////////////////////////////////////////////////////////
// Assignment: CG-04-A.01_StripifyShader (mostly identical with CG-04_D.01_BasicRendering)(Ver 2.1)                                          //
///////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	switch (item)
	{
		...
		case 3:
		{
			// delete old shader program and setup stripify shader files
			if (PROGRAM_ID) glDeleteProgram(PROGRAM_ID);

			argc = 4;
			argv[0] = "";
			argv[1] = "../../glsl/stripify.vert";
			argv[2] = "../../glsl/stripify.frag";
			argv[3] = "../../glsl/stripify1.frag";
			PROGRAM_ID = UtilGLSL::initShaderProgram(argc, argv);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	glutAddMenuEntry("Use Stripify Shader", 3);
